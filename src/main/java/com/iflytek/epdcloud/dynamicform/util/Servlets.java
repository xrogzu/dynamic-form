package com.iflytek.epdcloud.dynamicform.util;
...
public class Servlets {
    ...
    private static final String[] ADDR_HEADER =
    ...
    public static String getParameter(HttpServletRequest request, Map<String, String[]> queryMap,
            String name) {
